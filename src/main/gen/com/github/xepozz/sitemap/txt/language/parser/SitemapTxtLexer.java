...
class SitemapTxtLexer implements FlexLexer {
  ...
  private static final String ZZ_CMAP_BLOCKS_PACKED_0 =
    "\11\0\1\1\1\2\2\3\1\4\22\0\1\1\144\0"+
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    "\1\2\1\3\1\4\1\0\1\5\2\2\1\0\2\2"+
    "\1\0\1\3\12\0\1\4\2\0";
   ...
   */
  SitemapTxtLexer(java.io.Reader in) {
    this.zzReader = in;
  }
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 5: break;
          case 3:
            { yybegin(YYINITIAL); return SitemapTxtTypes.EOL;
            }
          // fall through
          case 6: break;
          default:
